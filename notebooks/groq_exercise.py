...
class ChatGroq:
    ...
    def __init__(self, model, temperature=0, max_retries=2):
        print(">> initializing ChatGroq with model:", model)
...
def implement_query_model(llm, prompt):
    ...
    prompt = PromptTemplate(
        ...
        template='Explain the following question if you are certain you know the answer. If not, say "I am not sure."'
    )
...
def implement_compare_models(prompt):
    ...
    mmodel4, llama4 = implement_llama_4_model()
    response4 = implement_query_model(llama4, prompt)

    model33, llama33 = implement_llama_3_3_model()
...
def main():
    ...
    try:
        ...
        model4, llama4 = implement_llama_4_model()
        print(">>> model", model4)
